...
export default function Language_Gi({navigation})
{
  ...
  var touchProps = {
    activeOpacity: 1,
    underlayColor: '#8B4500',                               // <-- "backgroundColor" will be always overwritten by "underlayColor"
    ...
    const onPressHandler_Lang_Design_Eng=()=>{
      ...
      const onPressHandler_Lang_Design_Mar=()=>{
        navigation.navigate('GiSearch_Marathi')
      }
...
//                     <Text style={{fontSize:28,textAlign:'center',marginTop:20}}>Language Selection GI</Text>
//                     <TouchableOpacity
//                     style={styles.button}
