...
export default class GiSearch_Gujarati extends Component
{
  ...
  validateCaptchaCode = () => {
    ...
    if (this.state.textInputHolder == temp) {
      ...
      this.props.navigation.navigate('GiStatus_Gujarati')
    }
    else {
      //Captcha not match
  ...
  RaiseQueryGi=()=>{
    this.props.navigation.navigate('GiQuery_Gujarati')
    ...
    <View style={styles.container}>
        ...
        <ScrollView>
            ...
            <View style={styles.headermiddle}>
                <Text style={styles.headermiddletxt}>GI શોધ</Text>
            </View>
            ...
            <View>
                ...
                >
                    ...
                    પ્રશ્ન ઉઠાવવા માટે અહીં ક્લિક કરો
                    </Text>
                </TouchableOpacity>
            </View>
        ...
        <View style={styles.captchaContainerView}>
          ...
          <View style={ styles.captchaChildContainer}>
            ...
            કોડ દાખલ કરો<Text style={{color:'red'}}>*</Text>
            </Text>
            <TextInput
            style={{
              marginTop:20,
        ...
        <TouchableOpacity style={styles.button} onPress={this.validateCaptchaCode} >
          <Text style={styles.text}>આગળ વધો</Text>
        </TouchableOpacity>
